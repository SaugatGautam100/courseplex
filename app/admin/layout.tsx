  ...
  return (
    <div className="font-sans bg-slate-50 text-slate-800">
      <div className="relative flex min-h-screen">
        <aside className="sticky top-0 h-screen hidden md:flex"><AdminSidebar /></aside>
        <div className="flex-1 flex flex-col">
          ...
          {isMobileMenuOpen && (
            <div className="md:hidden fixed inset-0 z-40">
              <div className="absolute inset-0 bg-black/30" onClick={closeMobileMenu} aria-hidden="true"></div>
...
function MenuIcon(props: SVGProps<SVGSVGElement>) { return <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" {...props}><path d="M4 6h16M4 12h16M4 18h16" /></svg>; }