...
export const metadata = {
  title: "Terms and Conditions - Plex Courses",
  description: "Read the terms and conditions for using the Plex Courses platform and services.",
};
    ...
    <main className="min-h-screen bg-slate-50 text-slate-800 antialiased">
      ...
      <section className="mx-auto max-w-6xl px-4 pb-10 md:pb-12">
        <div className="prose prose-slate max-w-none">
          ...
          <p>
            By accessing and using the Plex Courses website and its services (the &quot;Service&quot;), you accept and agree to be bound by the terms and provision of this agreement.
          </p>
          ...
          <p>
            All payments for course packages are final. **Plex Courses has a strict no-refund policy.** Once a payment is made and access to a course is granted, you are not eligible for a refund under any circumstances.
          </p>
          <p>
          ...
          <p>
            Plex Courses will not be liable for any indirect, incidental, special, consequential, or punitive damages, including loss of profits, data, or other intangibles, resulting from your access to or use of, or inability to access or use, the service.
          </p>
