...
export const metadata = {
  title: "Disclaimer - Skill Hub Nepal",
  description: "Disclaimer regarding earnings, content, and use of the Skill Hub Nepal platform.",
};
    ...
    <main className="min-h-screen bg-slate-50 text-slate-800 antialiased">
      ...
      <section className="mx-auto max-w-6xl px-4 pb-10 md:pb-20">
        <div className="prose prose-slate max-w-none">
          ...
          <p>
            The information contained on the Skill Hub Nepal website is for general information purposes only. While we endeavor to keep the information up to date and correct, we make no representations or warranties of any kind, express or implied, about the completeness, accuracy, reliability, suitability, or availability with respect to the website or the information, products, services, or related graphics contained on the website for any purpose.
          </p>
          <p>
            Our service may contain links to external websites that are not provided or maintained by or in any way affiliated with Skill Hub Nepal. Please note that Skill Hub Nepal does not guarantee the accuracy, relevance, timeliness, or completeness of any information on these external websites.
          </p>

          <h2>No Professional Advice</h2>
          <p>
            The information provided by Skill Hub Nepal is for educational purposes only and is not a substitute for professional financial or legal advice. Always seek the advice of a qualified professional with any questions you may have regarding a financial or legal matter.
          </p>
        </div>
      </section>
    </main>
